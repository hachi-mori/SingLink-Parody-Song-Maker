...
添付画像を基準に横長画面を追加調整済み。1200px幅の問題画面は選択肢を各260pxから360pxへ広げ、問題文と選択肢を1行表示。解答画面は1895px幅で歌詞カード左端を586pxから802px、1280px幅で493pxから525pxへ右寄せし、キャラクター本体との重なりを解消。820x1180と390x844は横スクロールなし。
